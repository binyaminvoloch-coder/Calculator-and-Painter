...
<head>
    ...
    <style>
        ...
        .lang-wrapper {
            ...
            background: var(--bg-app); padding: 8px; border-radius: 10px;
        }
        #lang-selector {
...
<body>
    <div id="side-panel">
        <div class="section-box">
            <div class="lang-wrapper">
                <span data-i18n="lang_label" style="font-size: 0.85rem; font-weight: bold;">שפה / Language:</span>
            ...
            <h3 data-i18n="calc_title">מחשבון מדעי</h3>
        ...
        <div class="section-box">
            <h3 data-i18n="history_title">היסטוריה מקומית</h3>
            <div id="history-list"></div>
        </div>
        <div class="section-box" style="border-bottom:none;">
            <h3 data-i18n="tools_title">כלי לוח וצבעים</h3>
            ...
            <div class="controls" style="margin-bottom:15px;">
                <span data-i18n="width_label" style="font-size: 0.8rem;">עובי:</span>
                <input type="range" id="penWidth" min="1" max="25" value="3" style="flex:1">
            </div>
            <div class="controls">
                <button class="action-btn undo-btn" onclick="undo()" data-i18n="undo_btn">↩ בטל צעד</button>
                <button class="action-btn" id="eraserBtn" onclick="toggleEraser()" data-i18n="eraser_btn">🧼 מחקן</button>
                <button class="action-btn" style="background:#ba1a1a;" onclick="clearCanvas()" data-i18n="clear_btn">🗑 נקה הכל</button>
            </div>
        </div>
    </div>
    ...
    <script>
        // --- מערכת תרגום ---
        const translations = {
            he: { lang_label: "בחר שפה:", calc_title: "מחשבון מדעי", history_title: "היסטוריה מקומית", tools_title: "כלי לוח וצבעים", width_label: "עובי:", undo_btn: "↩ בטל צעד", eraser_btn: "🧼 מחקן", clear_btn: "🗑 נקה הכל", error: "שגיאה", dir: "rtl" },
            en: { lang_label: "Language:", calc_title: "Scientific Calculator", history_title: "Local History", tools_title: "Board Tools", width_label: "Width:", undo_btn: "↩ Undo", eraser_btn: "🧼 Eraser", clear_btn: "🗑 Clear All", error: "Error", dir: "ltr" },
            ar: { lang_label: "اختر اللغة:", calc_title: "آلة حاسبة علمية", history_title: "السجل المحلي", tools_title: "أدوات اللوحة", width_label: "السمك:", undo_btn: "↩ تراجع", eraser_btn: "🧼 ممحاة", clear_btn: "🗑 مسح الكل", error: "خطأ", dir: "rtl" },
            ru: { lang_label: "Язык:", calc_title: "Калькулятор", history_title: "История", tools_title: "Инструменты", width_label: "Толщина:", undo_btn: "↩ Отмена", eraser_btn: "🧼 Ластик", clear_btn: "🗑 Очистить", error: "Ошибка", dir: "ltr" }
        };
        ...
        function solve() {
            try {
                ...
                if(!exp) return;
                let result = math.evaluate(exp.replace('×', '*').replace('÷', '/'));
        ...
        // --- רישום ה-SERVICE WORKER (ל-PWABuilder) ---
